...
/**
 * <p>Java class for SF90RecordDataElement complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SF90RecordDataElement"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="errorCode" type="{http://www.model.onenetwork.com/position}Position"/&gt;
...
@XmlType(name = "SF90RecordDataElement", propOrder = {
    "controlIdentifier",
    "messageTypeCode",
    "errorCode",
...
public class SF90RecordDataElement {
    ...
    @XmlElement(required = true)
    protected Position errorCode;
    @XmlElement(required = true)
    protected Position narrativeMessageText;
    @XmlElement(defaultValue = "SF90")
    protected String defaultControlIdentifier;
    @XmlElement(defaultValue = "SF|US-ISF10")
     ...
     *     
     */
    public void setErrorCode(Position value) {
